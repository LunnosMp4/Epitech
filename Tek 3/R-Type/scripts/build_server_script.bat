...
REM Installation des dépendances avec Conan dans le dossier courant (Server)
...
REM Exécution de CMake avec le fichier toolchain de Conan depuis Server/build
...
REM Compilation du projet depuis Server/build
