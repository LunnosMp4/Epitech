...
int analyse_events(game_t *game, sfEvent event, entity_t *entity, animation_t *animation);
...
void run_animation(animation_t *animation, game_t *game, entity_t *entity, sfVector2f movex);
void close_window(sfRenderWindow *window);
game_t *create_game(sfVideoMode mode, game_t *game, sfColor clear_color);
void process_game(sfEvent event, game_t *game, entity_t *entity, animation_t *animation);
